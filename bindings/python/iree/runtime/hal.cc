...
void SetupHalBindings(pybind11::module m) {
  // Enums.
  py::enum_<enum iree_hal_memory_type_t>(m, "MemoryType")
      ...
      .export_values();
  py::enum_<enum iree_hal_buffer_usage_t>(m, "BufferUsage")
      ...
      .export_values();
  py::enum_<enum iree_hal_memory_access_t>(m, "MemoryAccess")
      ...
      .export_values();
  py::enum_<enum iree_hal_element_type_t>(m, "HalElementType")
      ...
      .value("BOOL_8",
             static_cast<iree_hal_element_type_t>(IREE_HAL_ELEMENT_TYPE_VALUE(
